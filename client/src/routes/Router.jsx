...
import { AboutUs, Blog, Cart, ContactUs, Home, Orders, Product, Sale, Shope, WishList } from "../pages"
  ...
  return (
    <AnimatePresence mode="wait" initial={false}>
      ...
      <Routes location={location} key={id}>
        <Route path="/admin/*" element={<PrivateRoutes element={<AdminRouter />} role="admin" loading={loading} />} />
