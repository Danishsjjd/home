...
const ReviewForm = ({ user, productId, setProduct, isDeleted }) => {
  ...
  return (
    <div className="top-16 w-full space-y-8 rounded bg-neutral-lightest p-4 md:sticky">
          ...
          return (
            <form onSubmit={handleSubmit}>
              <div>
                ...
                <Input name="name" app disabled value={user.username ? user.username : ""} />
              </div>
              <div>
                <h4 className="mb-1">Your Email</h4>
                <Input name="email" app disabled value={user.email ? user.email : ""} />
              </div>
              <div>
